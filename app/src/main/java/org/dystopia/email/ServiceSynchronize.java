...
public class ServiceSynchronize extends LifecycleService {
        ...
        .observe(
            ...
            new Observer<List<TupleNotification>>() {
              ...
              public void onChanged(List<TupleNotification> messages) {
                NotificationManager nm = getSystemService(NotificationManager.class);
                LongSparseArray<List<TupleNotification>> messagesByAccount =
                    new LongSparseArray<>();
  ...
  private Notification.Builder getNotificationGroup(
      String accountName, Integer accountColor, List<TupleNotification> messages) {
    ...
    for (EntityMessage message : messages) {
      ...
      sb.append(" ")
          .append(df.format(new Date(message.sent == null ? message.received : message.sent)));
      sb.append("<br>");
    }
  ...
  private List<Notification> getNotificationUnseen(List<TupleNotification> messages, Pair account) {
    ...
    for (TupleNotification message : messages) {
      ...
      PendingIntent piDelete =
          PendingIntent.getService(this, PI_IGNORED, ignored, PendingIntent.FLAG_UPDATE_CURRENT);
