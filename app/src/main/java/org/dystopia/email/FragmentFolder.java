                                ...
                                try {
                                    ...
                                    if (folder == null || !folder.name.equals(name)) {
                                        ...
                                        if (folder == null) {
                                            ...
                                            IMAPFolder ifolder =
                                                    (IMAPFolder) istore.getFolder(name);
                                            if (ifolder.exists()) {
                                                throw new IllegalArgumentException(
                                                        getString(
                                                                R.string.title_folder_exists,
                                                                name));
                                            }
                                            ...
                                            IMAPFolder iold =
                                                    (IMAPFolder) istore.getFolder(folder.name);
                                            IMAPFolder ifolder =
                                                    (IMAPFolder) istore.getFolder(name);
                                            if (ifolder.exists()) {
                                                throw new IllegalArgumentException(
